...
export PLUGIN_NAME="plugin-conference-sip-failover"
export FLEX_UI_FOLDER="plugin-conference-sip-failover"
...
twilio flex:plugins:deploy --version "1.0.0-$BUILD_NUMBER" --description "plugin-conference-sip-failover" --changelog "CI/CD initatied changes"

# Release the Flex plugin
echo "Releasing the Flex plugin..."
twilio flex:plugins:release --plugin "$PLUGIN_NAME@1.0.0-$BUILD_NUMBER" --name "Autogenerated Release $BUILD_NUMBER" --description "plugin-conference-sip-failover CI/CD release"
